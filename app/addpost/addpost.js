...
angular.module('EnoticeBoardWebApp.addpost', ['ngRoute', 'firebase'])
...
.controller('addpostCtrl', ['$scope','$firebaseArray','$firebaseObject','$firebaseAuth' ,function($scope,$firebaseArray,$firebaseObject,$firebaseAuth){
  var ref ;
 var downloadURL;
  var Department;
  var Name;
